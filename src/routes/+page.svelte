...
<svelte:head>
	<title>phurit.de</title>
	<meta name="description" content="Stay hungry, Stay Phulish." />
</svelte:head>
			...
			<div class="window-content">
				<h1 class="title">
					phurit<span style="color: #4fd1c5"
						>.de<span
							class="cursor animate__animated animate__flash animate__infinite animate__slower"
							>_</span
						></span
					>
				</h1>
